...
def custom_collate_fn(batch):
    ...
    return {
        ...
        'phoneme_sequence': phoneme_sequence.to(dtype=torch.int64),  # Keep phoneme_sequence as int64 if required
        'phoneme_durations': phoneme_durations.to(dtype=torch.bfloat16),
    }
